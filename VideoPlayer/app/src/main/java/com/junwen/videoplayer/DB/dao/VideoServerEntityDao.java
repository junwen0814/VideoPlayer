...
/** 
 * DAO for table VideoServerEntityInfo.
*/
public class VideoServerEntityDao extends AbstractDao<VideoServerEntity, Long> {

    public static final String TABLENAME = "VideoServerEntityInfo";

    /**
     * Properties of entity VideoServerEntity.<br/>
    ...
    */
    ...
    public VideoServerEntityDao(DaoConfig config) {
        super(config);
    }
    
    public VideoServerEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'VideoServerEntityInfo' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'VideoServerEntityInfo'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, VideoServerEntity entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public VideoServerEntity readEntity(Cursor cursor, int offset) {
        VideoServerEntity entity = new VideoServerEntity( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, VideoServerEntity entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(VideoServerEntity entity, long rowId) {
        entity.setVid(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(VideoServerEntity entity) {
        if(entity != null) {
